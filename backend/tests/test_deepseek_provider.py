...
def test_mock_http_real_provider_path_generates_from_tool_evidence_not_fake_canned_text():
    ...
    def handler(request):
        ...
        terminal = {"id":"answer","type":"function","function":{"name":"submit_grounded_answer","arguments":json.dumps({"answer":"Polybius records a battle at Cannae.","evidence_ids":["cannae-1"],"insufficient_evidence":False})}}
