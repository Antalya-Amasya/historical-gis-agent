...
export type RomanRoadLeg = { leg_index?: number; source_anchor_id?: string; destination_anchor_id?: string; reconstruction_method?: string; limitation?: string | null; failure_status?: string | null; terrain_candidate?: { metrics?: { distance_m?: number }; cost_breakdown?: CandidateRouteScore } | null; candidate?: { network_distance_m?: number } | null; };
